...
export default function Region(){
 ...
 return <main className="focusShell dfHigh">
  <DFBrandHeader/>
  <DFLiveNotice placement="region" region={name==="전국"?null:name}/><section className="dfRegionIntro"><small>REGIONAL INTELLIGENCE</small><h1>{name==="전국"?"전국 개발 흐름":name+"의 개발 흐름"}</h1><p>개발사업·정책·고시·분양·금융 정보를 지역 기준으로 모아봅니다.</p></section>
  ...
  <DFLiveAd placement="region" region={name==="전국"?null:name}/><section className="dfRegionAction"><small>LAND INTELLIGENCE</small><b>{name==="전국"?"관심 부동산을 등록하세요":name+"의 내 부동산을 추적하세요"}</b><span>주변 개발사업과 고시·실거래 변화를 한곳에서 확인합니다.</span><a href="/search">땅짚고에서 등록하기 →</a></section><DFBottomNav active="region"/>
 </main>
}
