...
export default function FocusHome(){
 ...
 <DFLiveAd placement="home"/><section className="focusHero dfLandCompact"><div className="focusLandBox"><div className="focusLandBoxHead"><div><small>LAND INTELLIGENCE</small><h1>땅짚고</h1></div><span className="focusLandBadge">내 부동산 관리</span></div><p className="focusLandTagline">내 땅의 변화를 놓치지 않도록</p><p className="focusLandDesc">토지·건물을 등록하면 주변 개발사업·도시계획·실거래·개발호재 변화를 추적합니다.</p><div className="focusHeroActions"><a className="focusHeroPrimary" href="/search">부동산 분석 시작</a><a className="focusHeroSecondary" href="/search">땅짚고 보기 →</a></div></div></section>
