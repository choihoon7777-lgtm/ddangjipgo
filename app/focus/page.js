...
<div className="focusTabs"><b>홈</b>{sections.map(x=><a href={x==="최신뉴스"?"/focus/live":x==="지역 FOCUS"?"/focus/region":x==="개발사업"?"/focus/projects":"/focus/live"} key={x}>{x}</a>)}</div>
...
<div className="focusHeroActions"><a className="focusHeroPrimary" href="/search">내 부동산 등록</a><a className="focusHeroSecondary" href="/search">땅짚고 보기 →</a></div>
</div></section>
<section className="focusBlock"><div className="focusTitle"><h2>오늘의 주요 뉴스</h2><a href="/focus/live">더보기 →</a></div>{["개발사업 주요 변경사항을 한눈에 확인하세요","새로운 정책·고시의 핵심 변화만 빠르게 정리합니다","교통·산업·분양 정보를 지역과 사업별로 연결합니다"].map((x,i)=><article className="focusNews" key={x}><div><small>{["개발사업","정책·고시","금융"][i]}</small><h3>{x}</h3><p>공식자료 기반 · 검증 후 발행</p></div><div className="focusThumb">DF</div></article>)}</section>
...
<nav className="focusBottom"><a href="/focus">⌂<b>홈</b></a><a href="/focus/live">▤<b>뉴스</b></a><a href="/focus/region">◎<b>지역</b></a><a href="/search">◇<b>땅짚고</b></a><a href="/my">☰<b>MY</b></a></nav></main>}